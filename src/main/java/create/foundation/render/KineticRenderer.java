...
public class KineticRenderer implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelId,
        ...
        t.startDrawingQuads();
        t.setNormal(0, -1, 0);
        renderer.renderFaceYNeg(block, 0, 0, 0, renderer.getBlockIconFromSide(block, 0));
        t.setNormal(0, 1, 0);
    ...
    private static IIcon icon(Block block, int side) {
        IIcon ic = block.getBlockTextureFromSide(side);
        return ic != null ? ic : net.minecraft.init.Blocks.stone.getBlockTextureFromSide(side);
    }
